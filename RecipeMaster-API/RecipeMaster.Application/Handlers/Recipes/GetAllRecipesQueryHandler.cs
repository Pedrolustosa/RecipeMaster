...
public class GetAllRecipesQueryHandler(IRecipeRepository repository, IMapper mapper, ILogger<GetAllRecipesQueryHandler> logger) : IRequestHandler<GetAllRecipesQuery, IEnumerable<RecipeDTO>>
{
